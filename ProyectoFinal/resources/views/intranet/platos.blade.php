<x-app-layout>
    <x-slot name="header">
        <a href="/intranet/restaurante"><h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Restaurante') }}
        </h2></a>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="p-4 flex">
                    ...
                    <form action="/intranet/restaurante/{{$restaurante_id}}">
                        @csrf
                ...
                @if ($platos->count() == 0)
                    <h1>No hay ningun plato metido todavia</h1>
                @else
                        ...
                        <tbody>
                            ...
                            @foreach ($platos as $plato)
                                <tr class="border-b hover:bg-orange-100 bg-gray-100">
                                    <td class="p-3 px-5" style="width: 180px">{{ $plato->nombre }}</td>
                                    <td class="p-3 px-5" style="width: 235px">{{ $plato->descripcion }}</td>
                                    <td class="p-3 px-5" style="width: 235px"><img
                                            src=" {{ url('storage/img/platos', [$plato->foto]) }}" alt=".." width="60%">
                                    </td>
                                    {{-- <td class="p-3 px-5">{{ $plato->foto }}</td> --}}
                                    <td class="p-3 px-5" style="width: 150px">{{ $plato->precio }} €</td>
                                    <td class="p-3 px-5" style="width: 150px">{{ $plato->categoria }}</td>
                                    <td class="p-3 px-5 flex justify-end">
                                        <div style="margin-top: 35px; width: 100%;">
                                            {{-- <a href="/fooding/restaurante/{{ $plato->id }}">
                                                <button style=" margin-left: -85px; margin-right: 10px; float: left;"
                                                    type="button"
                                            ...
                                            <a href="/intranet/restaurante/plato/{{ $plato->id }}/delete">
                                                <button style="margin-right: 30px; margin-left: -150px; float: right"
                                                    type="button"
                                                    class="text-sm bg-red-500 hover:bg-red-700 text-white py-1 px-3 rounded focus:outline-none focus:shadow-outline">
                                                    Delete
                ...
                <div class="flex flex-col w-full h-auto ">
                    ...
                    <div
                        ...
                        <div class=" flex items-center justify-center">
                            ...
                            <form action="/intranet/restaurante/{{ $plato->id }}/edit" method="POST" id="form"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input
                                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                        name="precio" id="precio" type="text" placeholder="Ingresa tu nombre">
                                </div>
