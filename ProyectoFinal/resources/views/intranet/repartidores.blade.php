    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <h3 style="margin-left: 15px; font-size: 25px">Pedidos</h3>
                <form action="/intranet/repartidor">
                    @csrf
                        ...
                        @endphp
                            <tr class="border-b hover:bg-orange-100 bg-gray-100">
                                ...
                                <td class="p-3 px-5 flex justify-end">
                                    ...
                                    <button onclick="document.getElementById('edit').showModal()" style="margin-right: 10px;" type="button" class="focus:outline-none text-white text-sm py-1 px-2 rounded-md bg-yellow-500 hover:bg-yellow-600 hover:shadow-lg">
                                        Edit
